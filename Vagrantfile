...
Vagrant.configure('2') do |config|
    ...
    config.vm.define "DevOps4", primary: true do |machine|
        machine.vm.host_name = "DevOps4.local"
        machine.vm.network "private_network", ip: "192.168.10.7"
        ...
        machine.vm.synced_folder "DevOps4/", "/home/vagrant/mission"
